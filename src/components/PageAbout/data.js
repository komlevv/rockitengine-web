...
export const data = {
    main: {
        h: <>About <Span>us</Span></>,
        p: "RockitEngine is an international distributed collective of like-minded " +
    ...
    ourValues: {
        ...
        items: {
            a: {
                n: "01",
                h: "All-Remote",
                p: "RockitEngine is an all-remote company. We are 100% remote, " +
            ...
            b: {
                n: "02",
                h: "Fast",
                p: "We value our clients’ schedules and take pride " +
            ...
            c: {
                n: "03",
                h: "Proactive",
                p: "Going the extra mile is what we do in our work. " +
            ...
            d: {
                n: "04",
                h: "Transparent",
                p: "In an industry that requires " +
            ...
            e: {
                n: "05",
                h: "Boutique",
                p: "Every decision about how to structure a company has some " +
    ...
    work: {
        ...
        items: {
            a: {
                n: "01",
                h: "Client Managed",
                p: "Client managed dedicated team is a perfect setup when " +
            ...
            b: {
                n: "02",
                h: "RE Managed",
                p: "With RockitEngine Managed your dedicated team will be " +
    ...
    process: {
        ...
        items:{
            a: {
                n: "01",
                h: "Job Specification",
                p: "The goal of the specification is to understand your business " +
            ...
            b: {
                ...
                p: "We select candidates for the project. Our team members " +
            ...
            c: {
                n: "03",
                h: "Daily Reports",
                p: "We move fast and build things. We update you with daily " +
