...
export const data = {
    main: {
        ...
        h: <>Spotify <sup>x</sup> Hulu <Span>Cannes Lions</Span></>,
    ...
    overview: {
        h: "Overview",
        p: "RockitEngine helped envision a one-of-a-kind experience for Spotify and Hulu at Cannes Lions. With a brief to inspire guest’s " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "Spatial Design", "3d Visualiation", "Look Development", "Art Direction"
                ]
            },
            b: {
                n: "02",
    ...
    other: {
        a: {
            h: "",
            p: "Chateau Saint-Georges is a private historical " +
        ...
        b: {
            ...
            p: "Thousands have descended upon the French Riviera for the annual Cannes Lions Festival of Creativity. Artists, podcasters " +
        ...
        d: {
            h: "Impact",
            p: "An evening to remember which set a pitch-perfect " +
    ...
    next: {
        h: "Next Project",
        banner: {
            h: <>Spotify <sup>x</sup> Hulu Cannes Lions</>,
            p: "Celebration of the finest in storytelling, culture, and entertainment.",
            img: imgNext,
            imgShort: imgNext,
