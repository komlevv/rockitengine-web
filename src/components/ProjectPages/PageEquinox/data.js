...
import video_main from './images/equinox-form-video.mp4';
...
export const data = {
    main: {
        logo: logoEquinox,
        h: <>Equinox <Span>Form</Span></>,
        p: "Promise of substance and style, mirrored surfaces, " +
            "minimalism and an artful approach.",
        items: [
            {
                h: "Industry",
                p: "Fitness"
    ...
    overview: {
        h: "Overview",
        p: "Form is a creative retreat in the visionary eco-city of Arcosanti with three days of " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "Installation Design", "3d Visualiation", "Look Development", "Creative Direction"
                ]
            },
            b: {
                n: "02",
    ...
    other: {
        ...
        b: {
            h: "Approach",
            p: "Promise of substance and style, mirrored surfaces, minimalism " +
        ...
        d: {
            h: "",
            p: "Taking the form of the Equinox split ‘O’ — we created a space out of the " +
        ...
        e: {
            h: "Brand Film",
            p: "Surrounded by the desert landscape, the installation was also" +
                "leveraged to create a brand film that captured Equinox’s unique aesthetic.",
        },
        f: {
            h: "Process",
            p: "The activation became a ‘best-in-class’ example companywide for how Equinox " +
