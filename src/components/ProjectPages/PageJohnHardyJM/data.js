...
export const data = {
    main: {
        logo: logoJH,
        h: <>Made For <Span>Legends</Span></>,
        p: "Celebrating everyday strength, power and unapologetic " +
    ...
    overview: {
        h: "Overview",
        p: "Rooted in Balinese heritage, John Hardy’s new platform “Made For Legends” flipped the switch on the traditional " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "Beauty Retouching", "Jewelry Retouching", "De-aging VFX", "Color Correction"
                ]
            },
            b: {
                n: "02",
                ...
                p: "",
                subItems: [
                    "Foundry Nuke", "Mocha Pro", "Adobe Photoshop", "SilhouetteFX",
                ]
            },
        },
    },
    other: {
        a: {
            ...
            p: "“A legacy is a story. It’s more than what you’ve " +
        ...
        b: {
            h: "",
            p: "The campaign’s imagery is intended to be " +
        ...
        c: {
            h: "Process",
            p: "Pushing beyond the traditional convention of women being gifted jewelry by men, friends, and family, John Hardy's Made " +
        ...
        d: {
            h: "Impact",
            p: "Working with this team was an awe-inspiring experience. Not only does this campaign celebrate feminine individuality, " +
        ...
        e: {
            ...
            p: "Redefining what it means to be a legend, John Hardy connects the individual to the myth, mastery, and achievement of artistry. " +
        ...
        f: {
            h: "Jewelry Not " +
                ...
                "It’s Legendary.",
            p: "Perfect in its imperfection, John Hardy jewelry is as distinctive as the women who " +
        ...
        g: {
            h: "",
            p: "“Made for Legends” is a call for women to live on their own terms and build their legend –\n" +
    ...
    media: {
        ...
        imgVertical: [imgVertical1, imgVertical2, imgVertical3, imgVertical4, imgVertical5, imgVertical6],
        video: [videoWide1, videoWide3, videoWide4],
        videoVertical: [videoVertical1, videoVertical2, videoVertical3, videoVertical4,
            videoVertical5, videoVertical6],
    }
}
