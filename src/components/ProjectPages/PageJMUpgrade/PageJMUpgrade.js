...
const content = [
    ...
    <Video controls muted loop
           src={data.media.video[1]} poster={data.media.imgWide[1]}/>,
    ...
    <Video controls muted loop
           src={data.media.video[2]} poster={data.media.imgWide[2]}/>,
    <GridContainerHalf>
    ...
    <Video controls muted loop
           src={data.media.video[3]} poster={data.media.imgWide[3]}/>,
    data.media.imgSquare.slice(2).map((imgSrc, i) => (
        <ImageHalfWide src={imgSrc} key={i}/>
    )),
    <Gap/>,
    <BlockHeroTextM headerText={data.other.e.h} paragraphText={data.other.e.p}/>,
    <Video controls muted loop
           src={data.media.video[4]} poster={data.media.imgWide[4]}/>,
    data.media.imgSquareS.map((imgSrc, i) => (
        <ImageOneThird src={imgSrc} key={i}/>
    )),
    <Gap/>,
