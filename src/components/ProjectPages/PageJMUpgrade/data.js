...
export const data = {
    main: {
        logo: logoJM,
        h: <>Jessie Murph <Span>“Upgrade”</Span></>,
    ...
    overview: {
        h: "Overview",
        p: "Our partners directed “Upgrade” — a debut music video by an aspiring alternative-pop " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "3d Camera Tracking", "Matchmoving", "Snow Simulation", "Compositing", "Color Correction", "Cleanup"
                ]
            },
            b: {
                n: "02",
                ...
                p: "",
                subItems: [
                    "Autodesk Maya", "Maxon Redshift", "Adobe Premiere", "Foundry Nuke",
                    "Adobe Photoshop", "Pixel Farm PFTrack"
                ]
            },
        },
    },
    other: {
        a: {
            h: "Process",
            p: "The live action footage we received incorporated several independent shots fused together to look like one seamless clip. " +
        ...
        b: {
            h: "Matchmoving",
            p: "Since live action footage was not a truly continuous sequence, varying in focal distance and position within the venue, " +
        ...
        e: {
            h: "Look Development",
            p: "Our client was open to experiment with the look, so we generated a number of options for the snow motion and" +
        ...
        f: {
            h: "Impact",
            p: "The final clip premiered on YouTube with 3.000.000+ views " +
