...
export const data = {
    ...
    overview: {
        h: "Overview",
        p: "Clash de Cartier, jewelry that simultaneously champions and eschews classic forms, that balances clean design with an excess " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "Nail Retouch", "Skin Retouch", "Product Retouch", "Color Correction"
                ]
            },
            b: {
                n: "02",
    ...
    other: {
        a: {
            ...
            p: "We made skin-tones smooth, removed excessive wrinkles and blemishes, repaired " +
        ...
        b: {
            h: "Impact",
            p: "Clash De Cartier is a house icon. A collection that deeply explores intricacies in geometry, " +
