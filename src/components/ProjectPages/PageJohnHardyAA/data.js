...
export const data = {
    main: {
        logo: logoJH,
        h: <>AA<sup>x</sup>JH <Span>Collection</Span></>,
        p: "After fronting a campaign for the Bali-based jewelers, " +
    ...
    overview: {
        h: "Overview",
        p: "Model and muse to the world over, and most recently to the fine-jewelry makers at John Hardy, Adwoa Aboah has now taken " +
        ...
        items: {
            a: {
                ...
                p: "",
                subItems: [
                    "Skin Retouching", "Jewelry Retouching", "Color Correction", "Silhouette Correction"
                ]
            },
            b: {
                n: "02",
    ...
    other: {
        a: {
            h: "“I envisioned the girls that I love — my friends, " +
                "mum, sisters — wearing this jewelry”.",
            p: "Adwoa Aboah‘s jewelry line is a representation of her Ghanaian culture " +
        ...
        b: {
            h: "",
            p: "Adwoa’s collection is a form of self expression " +
        ...
        c: {
            h: "Iconic Shift",
            p: "When creating the capsule collection, Aboah with John Hardy’s creative " +
