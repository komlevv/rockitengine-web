...
export const data = {
    main: {
        h: <>What we <Span>do</Span></>,
        p: "We partner with global businesses to help create digital products " +
    ...
    services: {
        ...
        items: {
            a: {
                n: "01",
                h: "3D Visualization",
                p: "We transform complex design and architectural data " +
                ...
                subItems: [
                    "Interior Rendering", "Exterior Rendering", "Product Visualization",
                    "Architectural Visualization", "Spatial Design", "Product Design"
                ]
            },
            b: {
                n: "02",
                h: "Visual Effects",
                p: "Whether for reaching your audience or for making sure " +
                    "your footage looks perfect, visual effects are essential " +
                    "today. We keep ourselves armed with the latest tools " +
                    "and tech available.",
                subItems: [
                    "Compositing", "Camera Tracking", "Cleanup", "Look Development",
                    "Set Extension", "Matchmove", "Rotoscoping", "Screen Replacement",
                    "Object & Rig Removal", "Matte Painting",
                ]
            },
            c: {
                n: "03",
                h: "Post Production",
                p: "We handle every aspect of post— from editorial through " +
                    "color grading and visual effects, to final delivery so you can " +
                    "concentrate on creating inspirational content.",
                subItems: [
                    "Color Correction", "Editing", "Conform", "Post Supervision",
            ...
            d: {
                n: "04",
                h: "Retouching",
                p: "Great retouching today is largely a question of taste " +
                ...
                subItems: [
                    "Beauty Retouching", "Product Retouching", "Skin Retouching", "Hair Retouching",
                    "Makeup Retouching", "Silhouette Correction",
                ]
            },
            e: {
                n: "05",
                h: "Pitch Deck Design",
                p: "Whether you are a startup looking to raise capital and scale, an " +
                ...
                subItems: [
                    "Investor Pitch Deck", "Competition Pitch", "Team Presentation",
                    "Internal Events Deck", "Elevator Pitch", "Vision Presentation",
                ]
            },
            f: {
                n: "06",
                h: "Web Development",
                p: "If you need a new web app, an e-commerce, " +
    ...
    tools: {
        h: "Our tools",
        p: "We cover a vast array of technologies " +
        ...
        items: {
            ...
            b: {
                h: "3D",
                subItems: ["Autodesk Maya", "Autodesk 3ds Max", "zBrush", "Substance Painter",
                    "Substance Designer", "PFTrack",]
            },
            d: {
                h: "Render",
            ...
            e: {
                h: "Post",
                subItems: ["Adobe Premiere", "Adobe After Effects", "Foundry Nuke", "DaVinci Resolve",
                    "Mocha Pro",]
            },
            f: {
                h: "Software",
                subItems: ["React", "Javascript ES6", "Node.js", "Python",
                    "HTML & CSS"]
            },
        }
    },
